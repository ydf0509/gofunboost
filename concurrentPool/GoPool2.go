...
// GoroutinePool2 结构体
type GoroutinePool2 struct {
	maxWorkers int
	jobs       chan func() // 存储不同的工作函数
	once  sync.Once
}

// NewGoroutinePool2 创建一个新的协程池
func NewGoroutinePool2(maxWorkers int) *GoroutinePool2 {
	return &GoroutinePool2{
...
// Submit 提交一个工作到协程池
func (p *GoroutinePool2) Submit(job func()) {
